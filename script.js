...
let showFive = document.querySelector('#five')
...
for (let product of arr) {
    ...
    for (let key in icons) {
        ...
        img.src = `./img/${icons[key]}`

        span.innerHTML = product[key] ? product[key] : product.rating[key]

        div.append(img, span)
        ratingsBox.append(div)

    }

    buyButton.innerHTML = 'В избранное'
    ...
    itemHead.append(itemPhoto)
    itemBody.append(productName)
    itemBody.append(productInfo)
    itemBody.append(ratingsBox)
    itemBody.append(buyButton)
    ...
    itemHead.classList.add('item_head')
    itemBody.classList.add('item_body')
    productName.classList.add('name')
    productInfo.classList.add('info')
    buyButton.classList.add('buy')
    ratingsBox.classList.add('ratings')
    productName.innerHTML = 'MEN’S CLOTHING (120)'
    productInfo.innerHTML = 'Your perfect pack for everyday use and walks in the forest. Stash your laptop (up to 15 inches) in the padded sleeve, your everyday'
    itemPhoto.src = 'img/bag.png'
